...
function printCar(car?: {
  ...
  if (typeof car.chargeVoltage === "number") {
    str += `// ${car.chargeVoltage}v` //narrowing (increase specificty of branch)
  }
  console.log(str)
}
...
printCar(myArg)  //TS will approve this becasue we have a variable unlike the below example

// Here we defeated the error by spreading the object
printCar({
  ...{
    make: "Tesla",
    model: "Model 3",
